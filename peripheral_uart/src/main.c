...
static char gatt_string_msg[100] = "Hello, World But its here!";
...
// {
// 	const char *msg = "Hello, World But its here!";
...
// 	} 
// }
// // Define a static buffer to accumulate data across function calls
// static struct uart_data_t nus_data = {
//     .len = 0,
// };
